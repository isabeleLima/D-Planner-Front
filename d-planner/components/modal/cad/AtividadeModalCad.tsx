...
export default function AtividadeModalCad({ refetch }: Props) {
  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose} centered>
            ...
            <Container>
              <Row>
                ...
                <Col sm="auto" className="mt-3 auto">
                  <h4 className={style.atividade}>NOVA ATIVIDADE</h4>
                </Col>
              </Row>
            </Container>
          </Modal.Title>
        ...
        <Modal.Footer>
          <OrangeButton onClick={handleSubmit} Title="CADASTRAR"></OrangeButton>
        </Modal.Footer>
      </Modal>
    </>
  )
